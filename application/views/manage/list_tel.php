<form id="pagerForm" method="post" action="<?php echo site_url('manage/list_tel')?>">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="edit" href="<?php echo site_url('manage/edit_tel/{id}')?>" target="dialog" rel="edit_tel" warn="请选择一条记录" title="查看"><span>查看</span></a></li>
        </ul>
    </div>
