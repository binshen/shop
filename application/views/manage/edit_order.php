...
<div class="pageContent">
    <form method="post" enctype="multipart/form-data" action="<?php echo site_url('manage/save_product');?>" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);">
        <div class="pageFormContent" layoutH="55">
        	<fieldset style="width: 95%">
				...
				<dl>
					...
					<dd>
						...
						if($head->status == 3) echo '<font color="green">已完成</font>';
						?>
					</dd>
				</dl>
				...
				<dl class="nowrap">
					<dt>备注：</dt>
					<dd>
						<?php echo $head->remark;?>
						<a class="fahuo" href="<?php echo site_url('manage/remark/'.$head->id)?>" target="dialog" rel="add_pics" title="修改备注" width="800" height="370" mask=true>备注</a>
					</dd>
				</dl>
			...
			<?php endif;?>
			<?php if($head->status == 5):?>
				<ul>
					<a class="fahuo" href="<?php echo site_url('manage/refund/'.$head->id)?>" target="dialog" rel="add_pics" title="退款" width="800" height="370" mask=true>退款</a>
				</ul>
			<?php endif;?>
			<?php if($head->status > 2):?>
				<fieldset>
