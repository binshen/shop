<form id="pagerForm" method="post" action="<?php echo site_url('manage/list_score')?>">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="<?php site_url('manage/list_score')?>" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	...
	<div class="panelBar" >
		<div class="pages">
			...
			<span>条，共<?php  echo $countPage;?>条 总计:<font color="red"><?php echo $sum_score;?>分</font> 已使用:<font color="red">￥<?php echo $tixian;?></font></span>
		</div>		
